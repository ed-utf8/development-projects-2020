...
public class PlayCommand implements Command {
    ...
    public PlayCommand(Manager manager, Messages messages, MusicManager musicManager) {
    ...
    @Override
    public String[] getAliases() {return new String[]{"start"};}
    ...
    @Override
    public String getDescription() {return "Play/Resume a song";}
